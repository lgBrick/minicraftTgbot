...
def handle_guide_reply(message):
    ...
    prompt = f"""
        ...
        4. Главная цель — всегда давать четкий, правильный и полезный ответ на вопрос пользователя.
...
def handle_free_chat(message):
    ...
    prompt = f"""
        ...
        4. Никогда не отвечай шаблонами вроде "Чем я могу помочь?" или "Как искусственный интеллект...". Сразу переходи к делу в своем стиле.
        """
